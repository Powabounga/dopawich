        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col-md-4 d-flex align-items-center">
                <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                    <img src="/images/dopawich_logo.png" alt="Dopawich logo" width="30" height="24">
                </a>
                <span class="text-muted">© 2021 Dopawich</span>
            </div>

            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                <li class="ms-3"><a class="text-muted" href="https://twitter.com/dopawich"><img
                            src="/images/twitter-svgrepo-com.svg" alt="Dopawich logo" width="24" height="24"
                            class="bi"></a></li>
                <li class="ms-3"><a class="text-muted"
                        href="https://www.facebook.com/people/Dopawich/100090994624880/"><img
                            src="/images/facebook-svgrepo-com.svg" alt="Dopawich logo" width="24" height="24"
                            class="bi"></a></li>
                <li class="ms-3"><a class="text-muted" href="https://www.instagram.com/dopawich/"><img
                            src="/images/instagram-svgrepo-com.svg" alt="Dopawich logo" width="24" height="24"
                            class="bi"></a></li>
            </ul>
        </footer>
    </div>
